...
# this case that would be establishing the Peer Organization 2.
...
echo "Creating Peer Organization 2..."
echo "Deploying the TLS Server..."
./001-deploy-new-tls-ca-server.sh peer 2 meta &
sleep 2
./002-enroll-tls-admin-with-tls-server.sh peer 2
./003-register-enroll-fab-ca-admin-with-tls-server.sh peer 2
echo "Deploying Fabric Identity Server..."
./004-deploy-new-fab-ca-server.sh peer 2 meta &
sleep 2
./005-enroll-fab-admin-with-fab-server.sh peer 2
./006-register-enroll-org-admin-with-fab-server.sh peer 2
echo "Peer Organization 2 Created!"
