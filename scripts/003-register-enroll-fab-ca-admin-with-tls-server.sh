...
echo "./fabric-ca-client register -d --id.name org$2-fab-admin --id.secret org$2-fab-admin-pw -u https://localhost:${TLScreds[2]} --tls.certfiles tls-root-cert/tls-ca-cert.pem --mspdir tls-ca/${TLScreds[0]}/msp--csr.hosts \"127.0.0.1, hypertest, localhost, *.org0.fabsec.com, *.org1.fabsec.com, *.org2.fabsec.com\"";
./fabric-ca-client register -d --id.name org$2-fab-admin --id.secret org$2-fab-admin-pw -u https://localhost:${TLScreds[2]} --tls.certfiles tls-root-cert/tls-ca-cert.pem --mspdir \
...
echo "./fabric-ca-client enroll -d -u https://org$2-fab-admin:org$2-fab-admin-pw@localhost:${TLScreds[2]} --tls.certfiles tls-root-cert/tls-ca-cert.pem --mspdir tls-ca/org$2-fab-admin/msp --csr.hosts \"127.0.0.1, hypertest, localhost, *.org0.fabsec.com, *.org1.fabsec.com, *.org2.fabsec.com\""
./fabric-ca-client enroll -d -u https://org$2-fab-admin:org$2-fab-admin-pw@localhost:${TLScreds[2]} --tls.certfiles tls-root-cert/tls-ca-cert.pem --mspdir \
	tls-ca/org$2-fab-admin/msp --csr.hosts "127.0.0.1, hypertest, localhost, *.org0.fabsec.com, *.org1.fabsec.com, *.org2.fabsec.com"
